...
CREATE OR REPLACE Procedure get_region_codes 

(
    country_name IN VARCHAR2,
    county_name IN VARCHAR2,
    state_name IN VARCHAR2,
    constituency_name IN VARCHAR2,
    constituency_ward_name IN VARCHAR2,
    
    country_code OUT VARCHAR2,
    county_code OUT VARCHAR2,
    state_code OUT VARCHAR2,
    constituency_code OUT VARCHAR2,
    constituency_ward_code OUT VARCHAR2
