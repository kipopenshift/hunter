...
public class HunterClientJson {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		HunterClientJson other = (HunterClientJson) obj;
	...
	public String toString() {
		return "HunterClientJson [clientId=" + clientId + ", firstName="
				+ firstName + ", lastName=" + lastName + ", email=" + email
				+ ", userName=" + userName + ", receiver=" + receiver
				+ ", budget=" + budget + ", createdDate=" + createdDate
