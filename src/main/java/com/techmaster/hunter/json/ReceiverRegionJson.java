...
public class ReceiverRegionJson {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ReceiverRegionJson other = (ReceiverRegionJson) obj;
		if (auditInfo == null) {
	...
	public String toString() {
		return "ReceiverRegionJson [regionId=" + regionId + ", country="
				+ country + ", state=" + state + ", hasState=" + hasState
				+ ", county=" + county + ", constituency=" + constituency
				+ ", city=" + city + ", ward=" + ward + ", village=" + village
				+ ", longitude=" + longitude + ", latitude=" + latitude
				+ ", currentLevel=" + currentLevel + ", borderLongLats="
				+ borderLongLats + ", receiverCount=" + receiverCount
				+ ", auditInfo=" + auditInfo + "]";
	}
