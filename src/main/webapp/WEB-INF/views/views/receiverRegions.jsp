...
<script src="<c:url value='/static/resources/scripts/model/regionVM.js'/>"></script>
 ...
 -->
	...
	<div id="receiverRegionsUploadDiv" style="width:40%;margin-left:30%;height:200px;border:1px solid #C7EAFF;padding:25px;border-radius:4px;-webkit-box-shadow: 0 0 5px 2px #E2F3FF; -moz-box-shadow: 0 0 5px 2px #E2F3FF; box-shadow: 0 0 5px 2px #E2F3FF;" >
