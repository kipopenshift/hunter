...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/Hunter/static/resources/bootstrapDTable/DataTables-1.10.16/css/jquery.dataTables.css">
    <link rel="stylesheet" href="/Hunter/static/resources/bootstrapDTable/DataTables-1.10.16/css/dataTables.bootstrap4.min.css">
  ...
  <body>
	...
	<div class="container">
		<div class="row" style="margin-bottom: 2rem;">
			<div class="col-lg-12">
				<table id="example" class="table table-striped hunterDataTable">
					<thead>
						<tr>
							<th>Name</th>
							<th>Position</th>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <script src="/Hunter/static/resources/bootstrapDTable/DataTables-1.10.16/js/jquery.dataTables.min.js"></script>
    <script src="/Hunter/static/resources/bootstrapDTable/DataTables-1.10.16/js/dataTables.bootstrap4.min.js"></script>
